...
@csrf
<div class="card-body">
    @include('recepcaos.partials.validations')
    <div class="form-group">
        <label for="name">Nome</label>
        <input type="name" name="name" value="{{ $recepcao->name ?? old('name') }}" class="form-control" id="name"
...
<div class="card-footer">
    ...
    <a href="{{ route('recepcaos.list') }}" class="btn btn-default">Cancelar</a>
</div>
