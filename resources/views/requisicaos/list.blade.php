                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('requisicaos.create') }}"
                                                    ...
                                                    <td>
                                                        <div class="btn-group" style="gap: 10px;">
                                                            <a role="button" class="btn bg-lightblue"
                                                                href="{{ route('requisicaos.edit', $requisicao->id) }}">
...
<script>
    function confirmDelete(id) {
        Swal.fire({
            ...
            text: "Este requisicao será deletado permanentemente!",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    title: "Deletado!",
                    text: "O requisicao foi deletado.",
                    icon: "success"
                });
            }
        });
