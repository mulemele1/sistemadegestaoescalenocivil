...
@csrf
<div class="card-body">
    @include('fontes.partials.validations') 
    <div class="form-group">
        <label for="name">Nome</label>
        <input type="text" name="name" value="{{ $fonte->name ?? old('name') }}" class="form-control" id="name"
...
<div class="card-footer">
    ...
    <a href="{{ route('fontes.list') }}" class="btn btn-default">Cancelar</a>
</div>
    ...
    function salvar() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'fontes.list'; // Altere para a URL da sua página de listagem
            }
        });
    }
</script>