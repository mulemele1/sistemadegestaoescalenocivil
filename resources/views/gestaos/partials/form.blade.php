...
@csrf
<div class="card-body">
    @include('gestaos.partials.validations') 
...
<div class="card-footer">
    ...
    <a href="{{ route('gestaos.list') }}" class="btn btn-default">Cancelar</a>
</div>
    ...
    function salvar() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'gestaos.list'; // Altere para a URL da sua página de listagem
            }
        });
    }
</script>